  ...
  return (
    <div className="app-container">
      <style>{`
        ...
        .company-header { display: flex; align-items: center; gap: 12px; font-size: 19px; font-weight: 800; color: #1d1d1f; margin-bottom: 20px; }
        .company-icons { display: flex; align-items: center; gap: 10px; }
        .company-icons a { color: #86868b; display: inline-flex; align-items: center; justify-content: center; width: 30px; height: 30px; border-radius: 999px; transition: background 0.2s, color 0.2s; }
        .company-icons a:hover { color: #0071e3; background: rgba(0,113,227,0.08); }
